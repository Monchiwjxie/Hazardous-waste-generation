...
class MLPEnsemble:
    ...
    def test(self):
        ...
        print("Train Acc is {:.3f}".format(metrics.accuracy_score(self.y_train, self.train_pred_class)))
        print("Train F1 is {:.3f}".format(metrics.f1_score(self.y_train, self.train_pred_class)))

        print("Train R2 is {:.3f}".format(metrics.r2_score(self.y_train_reg, self.train_pred)))
        print("Train RMSE is {:.3f}".format(math.sqrt(metrics.mean_squared_error(self.y_train_reg, self.train_pred))))
        ...
        print("Test Acc is {:.3f}".format(metrics.accuracy_score(self.y_target, self.y_pred_class)))
        print("Test F1 is {:.3f}".format(metrics.f1_score(self.y_target, self.y_pred_class)))

        print("Test R2 is {:.3f}".format(metrics.r2_score(self.y_test, self.y_pred)))
        print("Test RMSE is {:.3f}".format(math.sqrt(metrics.mean_squared_error(self.y_test, self.y_pred))))
...
if __name__ == "__main__":
    ...
    #          'process_8', 'process_9', 'process_10', 'process_11', 'COD', 'pH', 'water', 'Fe', 'Cu', 'Ni', 'Zn']
    HWtype = 'HW17'
