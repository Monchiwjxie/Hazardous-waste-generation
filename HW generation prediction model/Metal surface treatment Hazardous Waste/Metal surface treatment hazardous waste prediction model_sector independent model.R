...
# SRP ---------------------------------------------------------------------
## training dataset ##
data_regr_train = read.csv("pathway.../data_3130_regr_train_somgn.csv") %>% 
  select(
    staff,
...
data_clas_train = read.csv("pathway.../data_3130_clas_train.csv") %>% 
  select(
    staff,
    process_1, process_2, process_3,
    process_9, process_10,process_11,
...
## testing dataset ##
data_test = read.csv("pathway.../C3130_infer.csv") %>% 
  mutate(
...
# MWR ---------------------------------------------------------------------
## training dataset ##
data_regr_train = read.csv("pathway.../data_3340_regr_train_somgn.csv") %>% 
  select(
    staff,
...
data_clas_train = read.csv("pathway.../data_3340_clas_train.csv") %>% 
  select(
    staff,
    process_1, process_2, process_3, process_4, 
    process_9, process_10,
  ...
  mutate(
    ...
    HW17logic = as.factor(HW17logic))
## testing dataset ##
data_test = read.csv("pathway.../C3340_infer.csv") %>% 
  mutate(
    industry = as.factor(industry),
    staff = as.factor(staff),
    process_1 = as.factor(process_1),
...
# MST ---------------------------------------------------------------------
## training dataset ##
data_regr_train = read.csv("pathway.../data_3360_regr_train_somgn.csv") %>% 
  select(
    staff,
    process_1, process_2, process_3, 
    process_9, process_10, process_11, 
...
data_clas_train = read.csv("pathway.../data_3360_clas_train.csv") %>% 
  select(
    staff,
    process_1, process_2, process_3, 
    process_9, process_10, process_11, 
  ...
  mutate(
    ...
    process_11 = as.factor(process_11))
## testing dataset ##
data_test = read.csv("pathway.../C3360_infer.csv") %>% 
  mutate(
    industry = as.factor(industry),
    staff = as.factor(staff),
    process_1 = as.factor(process_1),
...
# ECM ---------------------------------------------------------------------
## training dataset ##
data_regr_train = read.csv("pathway.../data_3982_regr_train_somgn.csv") %>% 
  select(
    staff,
...
data_clas_train = read.csv("pathway.../data_3982_clas_train.csv") %>% 
  select(
    staff,
    process_1, process_2, process_3, process_4, process_6,
    process_9, process_10, process_11, 
  ...
  mutate(
    ...
    process_11 = as.factor(process_11))
## testing dataset ##
data_test = read.csv("pathway.../C3982_infer.csv") %>% 
  mutate(
    industry = as.factor(industry),
    staff = as.factor(staff),
    process_1 = as.factor(process_1),
