...
# 模型构建 --------------------------------------------------------------------
#### 数据导入—训练数据及测试用例 ####
HWsum_combined_SMOGN = read.csv("HWsum_combined_smogn.csv")
data_test = read.csv("HWsum_combined_test.csv")
...
Performance_parameters = data.table(result_rsq, result_rmse, result_mae,result_mape,result_sse,
               model_param)
write.csv(Performance_parameters, "HWsum_combined_Performance_parameters.csv")
