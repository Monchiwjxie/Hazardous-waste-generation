...
# 数据导入 --------------------------------------------------------------------
#### 分类训练集及变量筛选 ####
data_clas_train = read.csv("one_typical_3130_classification_train.csv") %>% 
  select(staff,
         ...
         HW17logic)
#### 回归训练集及变量筛选 ####
data_regr_train = read.csv("one_typical_3130_Regression_train.csv")%>% 
  select(staff,
         process_1,process_2,process_3,process_4,process_5,
         process_6,process_7,process_8,process_9,process_10,
         process_11,
         ...
         HW17)
#### 测试集导入 ####
data_test = read.csv("HW17_3130_test.csv")
...
write.csv(confusion_matrix, "one_typical_3130_confusion_matrix.csv")
...
write.csv(regr_truth_response, "one_typical_3130_truth_response.csv")
...
write.csv(Performance_parameters, "one_typical_3130_Performance_parameters.csv")
...
write.csv(HW17_all_data_smogn_test_result, "one_typical_3130_alldata_truth_response.csv")
